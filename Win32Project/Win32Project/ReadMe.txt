========================================================================
    APPLICAZIONE WIN32: cenni preliminari sul progetto Win32Project
========================================================================

La creazione guidata applicazione ha creato questa applicazione Win32Project.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Win32Project.
...
Win32Project.ico
    File di icona utilizzato come icona dell'applicazione (32x32). Tale icona è inclusa dal file di risorse principale Win32Project.rc.

small.ico
    File di icona contenente una versione di dimensioni inferiori (16x16) dell'icona dell'applicazione. Tale icona è inclusa dal file di risorse principale Win32Project.rc.

/////////////////////////////////////////////////////////////////////////////
Altri file standard:

StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Win32Project.pch e il file dei tipi precompilato StdAfx.obj.
